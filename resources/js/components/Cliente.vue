                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <select class="form-control col-md-3" v-model="criterio">
                                ...
                                <option value="nombre">Teléfono</option>
                            </select>
                ...
                <div class="modal-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" v-model="num_documento" class="form-control" placeholder="Número del documento del cliente">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" v-model="email" class="form-control" placeholder="Email del cliente">
    ...
    export default {
        ...
        methods:{
            ...
            validarCliente(){
                ...
                if(!this.tipo_documento) this.errorMostrarMsjCliente.push("(*)El tipo de documento del cliente no puede estar vacío");
                if(!this.num_documento) this.errorMostrarMsjCliente.push("(*)El numero de documento del cliente no puede estar vacío");
