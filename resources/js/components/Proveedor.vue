                ...
                <div class="modal-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" v-model="email" class="form-control" placeholder="Email del proveedor">
    ...
    export default {
        ...
        methods:{
            ...
            validarProveedor(){
                ...
                if(!this.tipo_documento) this.errorMostrarMsjProveedor.push("(*)El tipo de documento del proveedor no puede estar vacío");
                if(!this.num_documento) this.errorMostrarMsjProveedor.push("(*)El numero de documento del proveedor no puede estar vacío");
